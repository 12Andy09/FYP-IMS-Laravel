...
<x-app-layout>
    ...
    <div class="py-12 sm:px-12 grid">
        ...
        <div class="md:w-4/5 flex bg-white overflow-hidden shadow-sm mx-auto grid grid-cols-2">
            <div class="p-4">
                <img class="h-24" src="{{ asset('images/default_profile.png') }}" alt="profile">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <form action="{{route('applications.store')}}" method="post">
                    ...
                    <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                        ...
                        @else
                        <a href="{{route('student_profile.index')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Go To Profile</a>
                        @endif
                    </div>
                </form>
            </div>
