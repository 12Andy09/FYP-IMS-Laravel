...
<h2 class="text-4xl font-medium py-8 mx-5">You are not authorized to post internship</h2>
<h2 class="text-4xl font-medium py-8 mx-5">Please contact admin for any issue</h2>
<button>
